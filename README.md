...
Execution time of the tatonnement algorithm (i.e. solving for the transition path) of the 'closed economy with income effects'-case run on an Intel(R) Xeon(R) Platinum 8180 CPU @ 2.50GHz:
